...
const mediaItems = [
  { id: 'sana-motion', type: 'Image', title: 'Sana in motion', text: 'A creative animated portrait of me, inspired by the photo on my home page.', image: '/images/sana-profile.jpeg', tone: 'from-[#e8d8b3] to-[#fca590]', animated: true },
...
function MediaPage() {
  const [selected, setSelected] = useState<typeof mediaItems[number] | null>(null);
      return <PageFrame><main className="page-wrap page-enter py-16 md:py-24"><PageTitle kicker="Media shelf" title={<>A gallery of <span className="text-[hsl(var(--primary))]">becoming.</span></>} intro="A collection of places, interests, and inspiration, including a creative animated portrait, UCLA, hiking, mantu, basketball, a Cadillac, a cute cat, and a video about Caitlin Clark." />
